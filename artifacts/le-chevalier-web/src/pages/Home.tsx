...
const LOGO_URL = `${import.meta.env.BASE_URL}images/logo-le-chevalier.png`;
        ...
        <FadeInSection>
          <div className="flex justify-center gap-1 mb-10">
            {[...Array(5)].map((_, i) => (
              <Star
                key={i}
                className="w-7 h-7 text-[#C9A14A]"
                fill="currentColor"
              />
            ))}
          </div>
          <p className="text-[#C9A14A] text-sm font-bold tracking-[0.3em] uppercase mb-4">
            Lo que dicen nuestros clientes
          </p>
          <h3 className="font-['Playfair_Display'] text-4xl md:text-5xl font-bold mb-20">
            Reseñas Reales
          </h3>
        </FadeInSection>
    ...
    <div className="min-h-screen bg-[#0D0D0D] text-white font-['Inter'] selection:bg-[#C9A14A] selection:text-black overflow-x-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center pt-20">
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center animate-bounce z-10">
          <span className="text-white/50 text-xs tracking-widest uppercase mb-2">
            Descubre
          </span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              {[
                ...
                <div key={i} className="flex flex-col items-center">
                  ...
                  <h3 className="font-['Playfair_Display'] text-lg md:text-xl text-white/90">
                    {diff}
                  </h3>
                </div>
              ))}
        ...
        <div className="container mx-auto px-6">
          <FadeInSection>
            <div className="text-center mb-20">
              <h2 className="text-[#C9A14A] text-sm font-bold tracking-[0.3em] uppercase mb-4">
                La Maestría
              </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
            ...
            <FadeInSection className="delay-100">
              <div className="bg-[#1F1F1F] p-10 border border-white/5 hover:border-[#C9A14A]/30 transition-colors duration-500 group">
                <h4 className="font-['Playfair_Display'] text-3xl mb-8 text-white group-hover:text-[#C9A14A] transition-colors">
                  Cortes
                </h4>
                <ul className="space-y-6">
                  {["Corte para caballero", "Corte para niño", "Arreglo de cejas"].map(
                    (item, i) => (
                      <li
                        key={i}
            ...
            <FadeInSection className="delay-200">
              <div className="bg-[#1F1F1F] p-10 border border-white/5 hover:border-[#C9A14A]/30 transition-colors duration-500 group">
                ...
                <ul className="space-y-6">
                  {["Barba y bigote", "Perfilado de barba", "Ritual de barba"].map(
                    (item, i) => (
                      <li
                        key={i}
                        className="flex justify-between items-center border-b border-white/10 pb-4"
        ...
        <div className="container mx-auto px-6">
          <FadeInSection>
            <div className="text-center mb-20">
              ...
              <h3 className="font-['Playfair_Display'] text-4xl md:text-5xl font-bold mb-6">
                Paquetes Exclusivos
              </h3>
              <p className="text-white/60 font-light text-lg">
                Elige el paquete ideal para tu estilo
              </p>
            </div>
          </FadeInSection>
            ...
            {packages.map((pkg, i) => (
              <FadeInSection key={i} className={`delay-${(i + 1) * 100}`}>
                <div className="bg-[#0D0D0D] border border-white/10 p-8 h-full flex flex-col hover:-translate-y-2 transition-transform duration-500 relative overflow-hidden group">
                  ...
                  <h4 className="font-['Playfair_Display'] text-2xl mb-6 text-[#C9A14A] z-10">
                    {pkg.name}
                  </h4>
                  <ul className="space-y-4 mb-8 flex-grow z-10">
                    {pkg.includes.map((item, j) => (
                      <li
                        key={j}
                        className="flex items-start text-white/80 font-light text-sm"
                      >
      ...
      <section className="py-32 bg-[#1F1F1F]">
        <div className="container mx-auto px-6 text-center max-w-4xl">
          <FadeInSection>
            ...
            <h3 className="font-['Playfair_Display'] text-4xl md:text-5xl font-bold mb-8">
              Productos Premium
            </h3>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {[
                ...
                <span
                  key={i}
                  className="px-6 py-3 border border-white/10 bg-[#0D0D0D] text-white/70 text-sm uppercase tracking-wider font-light hover:border-[#C9A14A]/50 transition-colors"
                >
                  {prod}
                </span>
              ))}
      ...
      <section
        id="contacto"
        className="py-24 bg-[#0D0D0D] border-t border-white/10"
      >
        <div className="container mx-auto px-6 max-w-6xl">
          {/* Header */}
          <FadeInSection>
            <p className="text-[#C9A14A] text-sm font-bold tracking-[0.3em] uppercase text-center mb-3">
              Visítanos
            </p>
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-stretch mb-12">
            ...
            <FadeInSection className="lg:w-1/2">
              <div className="rounded-2xl overflow-hidden shadow-2xl shadow-black/60 h-[380px]">
                <iframe
                  title="Mapa de Barbería Le Chevalier"
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-white/80 font-light">
                    Plaza Real, Real Solare, Querétaro
                  </p>
                </div>
              </div>
      ...
      <footer className="bg-[#0D0D0D] pt-20 pb-10 border-t border-white/10">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
            <div>
              ...
              <p className="text-white/50 font-light max-w-xs leading-relaxed">
                El ritual del caballero moderno. Experiencia, precisión y lujo en
                el corazón de Querétaro.
              </p>
            </div>

            <div>
              <h4 className="text-white uppercase tracking-widest text-sm font-bold mb-6">
                Enlaces
              </h4>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  href="https://www.instagram.com/barberialechevalier?igsh=aW5rbnJpYWo0cGR2&utm_source=qr"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/70 hover:bg-[#C9A14A] hover:text-black hover:border-[#C9A14A] transition-all"
                  aria-label="Instagram"
                >
                  <Instagram size={18} />
                </a>
                <a
                  href="https://www.facebook.com/share/1BpRxKz8zv/?mibextid=wwXIfr"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/70 hover:bg-[#C9A14A] hover:text-black hover:border-[#C9A14A] transition-all"
                  aria-label="Facebook"
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-white/30 text-xs font-light tracking-wider uppercase">
            <p>
              &copy; {new Date().getFullYear()} Barbería & Spa Le Chevalier.
            </p>
          ...
          >
            ...
            <div className="bg-[#1F1F1F] px-6 py-4 flex items-center gap-3 border-b border-white/10">
              ...
              <span className="text-white font-semibold uppercase tracking-widest text-sm">
                Barbería Le Chevalier — Plaza Real, Real Solare, Querétaro
              </span>
            </div>
            ...
            <div className="h-[60vh] min-h-[340px]">
              <iframe
                title="Mapa interactivo de Barbería Le Chevalier"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d939.5!2d-100.285262!3d20.5873017!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d343575feec8a7%3A0x34262e761ec6bf81!2sBarberia%20Le%20Chevalier!5e0!3m2!1ses!2smx!4v1744000000001!5m2!1ses!2smx"
                width="100%"
                height="100%"
                style={{ border: 0 }}
