      ...
      <section id="contacto" className="border-t border-white/10">
        <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="space-y-8 mb-12">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 font-light">Plaza Real, Querétaro</p>
                  </div>
                </div>
          ...
          <div className="h-[400px] lg:h-auto min-h-[500px]">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3734.856!2d-100.3899!3d20.5888!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjDCsDM1JzIwLjAiTiAxMDDCsDIzJzIzLjYiVw!5e0!3m2!1ses!2smx!4v1234567890" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
              allowFullScreen 
